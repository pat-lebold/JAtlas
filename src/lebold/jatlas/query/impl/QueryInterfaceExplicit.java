 ...
 *
 */
public class QueryInterfaceExplicit extends AQuery {

    public QueryInterfaceExplicit() {
	super("INTERFACE <interface package declaration>");
	...
	if(splitQuery.length == 2){
	    ...
	    if(command.equalsIgnoreCase("INTERFACE")){
